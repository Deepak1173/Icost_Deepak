                ...
                <div class="app-header__content">
                    ...
                    <div class="app-header-right">
                        <div class="header-dots">
                          ...
                          @if (auth()->user()->can('access', 'settings visible'))
                                ...
                                <div tabindex="-1" role="menu" aria-hidden="true"
                                    ...
                                    <div class="dropdown-menu-header">
                                        <div class="dropdown-menu-header-inner bg-plum-plate">
                                            <div class="menu-header-image" style="background-image: url('{{ asset('architect/images/dropdown-header/abstract4.jpg') }}');" ></div>
                                    ...
                                    <div class="grid-menu grid-menu-xl grid-menu-4col">
                                        <div class="no-gutters row">
                                            <div class="col-sm-6 col-xl-4">
                                                <button onclick="window.location.href='{{url('settings/logos')}}'" class="btn-icon-vertical btn-square btn-transition btn btn-outline-link">
                                                    <i class="pe-7s-film icon-gradient bg-night-fade btn-icon-wrapper btn-icon-lg mb-3"></i>
                                                    Logo/Favicon Icon
                                                </button>
                                            </div>
                                            <div class="col-sm-6 col-xl-4">
                                                <button onclick="window.location.href='{{url('settings/general')}}'" class="btn-icon-vertical btn-square btn-transition btn btn-outline-link">
                                                    <i class="pe-7s-config icon-gradient bg-night-fade btn-icon-wrapper btn-icon-lg mb-3"></i>
                                                    General Settings
                                                </button>
                                            </div>
                                            <div class="col-sm-6 col-xl-4">
                                                <button onclick="window.location.href='{{url('settings/smtp')}}'" class="btn-icon-vertical btn-square btn-transition btn btn-outline-link">
                                            ...
                                            @php /*
                                             <div class="col-sm-6 col-xl-4">
                                                <button id="TooltipDemo" class="btn-open-options btn-icon-vertical btn-square btn-transition btn btn-outline-link">
                                                    <i class="pe-7s-leaf icon-gradient bg-night-fade btn-icon-wrapper btn-icon-lg mb-3"></i>
                                                    Theme Settings
                                                </button>
                                            </div>
                                           */ @endphp
                            ...
                            <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu-header-inner bg-deep-blue">
                                            ...
                                            <div class="menu-header-content text-dark">
                                                ...
                                                <h6 class="menu-header-subtitle">You have
                                                    <b>{{ auth()->user()->unreadNotifications->count()  }}</b> notifications
                                                </h6>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="nav-item">
										...
										<span class="icon-wrapper icon-wrapper-alt rounded-circle">
										<span class="icon-wrapper-bg bg-primary" style="margin-left: -18px;">
											<i class='fas fa-comment' style="color: #372c3b;padding: 13px;"></i>
											</span>
											</span>
										</a>
								  </div>
                            ...
                            <div class="widget-content p-0">
                                <div class="widget-content-wrapper">
                                        ...
                                        <div class="btn-group">
                                            ...
                                            <a data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="p-0 btn">
                                                 ...
                                                 @if(\Storage::disk('public')->has(auth()->user()->avatar))
                                                                                <img src="{{ asset('storage/'.auth()->user()->avatar) }}" width="42" class="rounded-circle">
                                                                            @else
                                                                                <img src="{{ asset('images/no-img-100x92.jpg') }}" width="42" class="rounded-circle">
                                                                            @endif
                                                        ...
                                                        <div class="menu-header-content text-left">
                                                            <div class="widget-content p-0">
                                                                <div class="widget-content-wrapper">
                                                                        ...
                                                                        @elseif(auth()->user()->isRole('Supplier'))
                                                                    ...
                                                                    @endif
                                                                        ...
                                                                        @if(\Storage::disk('public')->has(auth()->user()->avatar))
                                                                                <img src="{{ asset('storage/'.auth()->user()->avatar) }}" width="62" class="rounded-circle">
                                                                            @else
                                                                                <img src="{{ asset('images/no-img-100x92.jpg') }}" width="62" class="rounded-circle">
                                                                            @endif
                                                                    ...
                                                                    <div class="widget-content-right mr-2">
                                                                           ...
                                                                           <button  data-toggle="modal" data-target="#Logout" type="button" class="btn-pill btn-shadow btn-shine btn btn-focus">{{ __('Logout') }}</button>
                                    ...
                                    <div class="widget-content-left  ml-3 header-user-info">
                                        ...
                                        <div class="widget-heading">{{ @Auth::user()->full_name." Profile"}}</div>
